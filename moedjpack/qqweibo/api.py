...
class API(object):
    ...
    @staticmethod
    def _pack_image(filecontent, contentname, max_size=1024, **params):
        ...
        #fp = open(filename, 'rb')
        body.append('--' + BOUNDARY)
        body.append('Content-Disposition: form-data; name="%s"; filename="%s"' % (contentname, "hidden".encode('utf-8')))
        body.append('Content-Type: %s' % file_type)
        body.append('Content-Transfer-Encoding: binary')
        body.append('')
        body.append(filecontent.read())
