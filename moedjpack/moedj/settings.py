...
DATABASES = {
    'default': {
        ...
        'NAME': '/'.join([_dir, 'MoePad.db']),                       # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'moedjpack.moedj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'moedjpack.moedj.wsgi.application'
